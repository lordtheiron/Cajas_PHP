...
<html>
    ...
    <head>
        ...
        <title>Registro Estantería - Boxed</title>
    ...
    <body id="page-top">
        <?php
        session_start();
        $arraypasillos = $_SESSION['$pasillo'];
        ?>
        <div id="wrapper">
                    ...
                    <div class="container-fluid">
                        <section class="register-photo" style="background-color: transparent;padding: 10px 0px;">
                            <div class="form-container" style="margin-top: 40px;">
                                ...
                                <form method="post" action="../Controladores/ControladorInsertarEstanteria.php" style="height: 525px;">
                                    ...
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text" name="codigo" placeholder="Código"
                                               minlength=4 maxlength=5 pattern="ES[0-9]{2,}"
                                               oninvalid="this.setCustomValidity('ES12-ES123')" required>
                                    </div>

                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text" name="material" placeholder="Material" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text" name="nLejas" placeholder="Nº Lejas" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <h2 class="text-center d-inline-flex"><strong>Ubicación:</strong>
                                            <select class="form-select d-inline-flex d-xl-flex flex-row justify-content-xl-start align-items-xl-start" 
                                                    style="width: 99.391px;" name="pasillo" id="pasillo" onchange="huecosLibres(this.value);" required>
                                                <option value="null" selected="">Pasillo</option>
                                                <?php foreach ($arraypasillos as $pasillo) { ?>
                                                    <option value="<?php echo $pasillo->id_pasillo; ?>">
                                                        <?php echo $pasillo->letra; ?>	
                                                    <?php } ?>
                                            </select>
                                            <select class="form-select d-inline-flex d-xl-flex flex-row justify-content-xl-start align-items-xl-start" 
                                                    style="width: 101.391px;" name="hueco" id="hueco" required>
                                                <option value="null" selected="">Hueco</option>
                                            </select>
                                        </h2>
                                    </div>
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="date" name="fAlta" required>
                                    </div>
                                    <div class="form-group mb-3">
