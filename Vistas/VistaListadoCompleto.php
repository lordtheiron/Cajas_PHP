            ...
            <nav class="navbar navbar-dark sticky-top align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-tachometer-alt"></i><span>Inventario Completo</span></a></li>
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h3 class="text-dark mb-4">Inventario almacén</h3>
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Inventario almacén</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                ...
                                <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                    <table class="table my-0" id="dataTable">
                                        ...
                                        foreach ($ArrayObj as $Object) {
                                            if ($idanterior != $Object->id_estanteria) {
                                                ?>
                                                <thead>
                                                    <tr>
                                                        <td><b><u>Estanteria:</u></b> <?php echo $Object->id_estanteria; ?></td>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $Object->material_estanteria; ?></td>
                                                        <td><?php echo $Object->nlejas; ?></td>
                                                        <td><?php echo $Object->lejas_ocupadas; ?></td>
                                                        <td><?php echo $Object->fecha_alta_estanteria; ?></td>
                                                        <td><?php echo $Object->letra; ?></td>
                                                        <td><?php echo $Object->numero; ?></td>
                                                    </tr>
                                                </tbody>

                                                <thead>
                                                    <tr bgcolor="#d4ffd7" style="font-weight: bold;">
                                                        <td></td>
                                                        <td>Codigo</td>
                                                        <td>Material</td>
                                                        <td>Color</td>
                                                ...
                                                <?php
                                                $idanterior = $Object->id_estanteria;
                                            }
                                            if ($Object->id_caja != null) {
                                                ?>
                                                <tbody>
                                                    <tr>
                                                        <td></td>
