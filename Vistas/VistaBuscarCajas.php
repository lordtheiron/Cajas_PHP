               ...
               <nav class="navbar navbar-dark sticky-top align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-trash"></i><span>Registrar Salida de Caja</span></a></li>
                    ...
                    <div class="container-fluid">
                        <section class="register-photo" style="background-color: transparent;padding: 10px 0px;">
                            <div class="form-container" style="margin-top: 40px;">
                                ...
                                <form method="post" action="../Controladores/ControladorAccionCaja.php" style="height: 525px;">
                                    <h2 class="text-center"><strong>Buscar Caja</strong></h2>
