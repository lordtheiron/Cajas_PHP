                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Datos de Caja</p>
                            </div>
                            <form action="../Controladores/controladorDevolucion.php">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <table class="table my-0" id="dataTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="estanterias" onChange="lejasLibres(this.value)">
                                                            <option values="nulo" selected="selected">Estanterias</option>
                                                            <?php foreach ($arrayEstanteriasLibres as $Estanteria) { ?>
                                                                <option value="<?php echo $Estanteria->getId() ?>">
                                                                    <?php echo "Codigo: " . $Estanteria->getCodigo(); ?>

                                                                <?php } ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select name="lejas" id="lejas">
                                                            <option value="null" selected="selected">Lejas</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                        </table>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 align-self-center">
                                            <button class="btn btn-primary d-block w-100" id="submitButton" type="submit" style="color: rgb(255,255,255);background-color: #00b5a8;">Registrar Devolución</button>
                                        </div>
                                        <div class="col-md-6">
